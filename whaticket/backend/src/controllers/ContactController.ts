...
export const store = async (req: Request, res: Response): Promise<Response> => {
  ...
  if (existingContact) {
    // Se o contato já existir, retorna os dados do contato existente
...
export const findOrCreate = async (req: Request, res: Response): Promise<Response> => {
  ...
  // Lógica para encontrar ou criar o contato

  return res.status(200).json({ message: "Contact processed" }); // Substitua isso pela lógica real
};
