...
const QuickMessageDialog = ({ open, onClose, quickemessageId, reload }) => {
  ...
  const handleAttachmentFile = (e) => {
    ...
    if (file) {
      setAttachment(file); // Aceitar qualquer tipo de arquivo sem validação
    }
  };
  ...
  // Função para limitar o número de caracteres do nome do arquivo
            ...
            <Form>
              <DialogContent dividers>
                <Grid spacing={2} container>
                  ...
                  {(quickemessage.mediaPath || attachment) && (
                    <Grid xs={12} item>
                      <Button startIcon={<AttachFileIcon />}>
                        {attachment ? truncateFileName(attachment.name) : quickemessage.mediaName}
                      </Button>
                      <IconButton
                  ...
                  {attachment && attachment.type.startsWith("audio/") && (
                    <Grid xs={12} item>
                      <audio controls>
                  ...
                  {attachment && (attachment.type === "image/jpeg" || attachment.type === "image/png") && (
                    <Grid xs={12} item>
                      <img 
                        src={URL.createObjectURL(attachment)} 
                        alt={attachment.name} 
              ...
              <DialogActions>
                {!attachment && !quickemessage.mediaPath && (
                  <Button
                    ...
                    variant="outlined"
                  >
                    <AttachFileIcon /> {i18n.t("quickMessages.buttons.attach")}
                  </Button>
                )}
                <Button
                  onClick={handleClose}
