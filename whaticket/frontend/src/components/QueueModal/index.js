...
const QueueModal = ({ open, onClose, queueId }) => {
  ...
  // Estado para o ColorPicker
  const [colorPickerModalOpen, setColorPickerModalOpen] = useState(false);

  // Inicialmente, os horários serão iniciados com valores vazios, conforme o SchedulesForm.
  const [schedules, setSchedules] = useState([
    { weekday: "Segunda-feira", weekdayEn: "monday", startTime: "", lunchTime: "", afterLunchTime: "", endTime: "" },
    { weekday: "Terça-feira", weekdayEn: "tuesday", startTime: "", lunchTime: "", afterLunchTime: "", endTime: "" },
    { weekday: "Quarta-feira", weekdayEn: "wednesday", startTime: "", lunchTime: "", afterLunchTime: "", endTime: "" },
    { weekday: "Quinta-feira", weekdayEn: "thursday", startTime: "", lunchTime: "", afterLunchTime: "", endTime: "" },
    { weekday: "Sexta-feira", weekdayEn: "friday", startTime: "", lunchTime: "", afterLunchTime: "", endTime: "" },
    { weekday: "Sábado", weekdayEn: "saturday", startTime: "", lunchTime: "", afterLunchTime: "", endTime: "" },
    { weekday: "Domingo", weekdayEn: "sunday", startTime: "", lunchTime: "", afterLunchTime: "", endTime: "" },
  ]);
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // Se a fila já possui horários, atualiza o state schedules
