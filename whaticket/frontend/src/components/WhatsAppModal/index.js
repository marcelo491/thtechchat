...
const handleUnlinkPrompt = () => {
  setSelectedPrompt(null); // Desvincula o prompt selecionado
};
...
>
  ...
  >
    <MenuItem value={null}>Nenhum</MenuItem> {/* Opção 'Nenhum' */}
    {prompts.map((prompt) => (
      <MenuItem
        key={prompt.id}
        value={prompt.id}
