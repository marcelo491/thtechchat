...
const useStyles = makeStyles((theme) => ({
  mainContainer: {
    backgroundColor: theme.palette.background.default, // Usa o background do tema
    color: theme.palette.textPrimary, // Usa a cor de texto principal do tema
    padding: '20px',
  },
  formControl: {
    display: 'flex',
  ...
  mainPaper: {
    ...
    boxShadow: theme.palette.mode === 'dark'
      ...
      : '0px 2px 10px rgba(0, 0, 0, 0.1)', // Sombra ajustada ao tema
    marginBottom: 40,
    overflow: 'hidden',
    backgroundColor: theme.palette.background.paper, // Fundo ajustado ao tema
  ...
  mainPaperTable: {
    ...
    boxShadow: theme.palette.mode === 'dark'
      ? '0px 2px 10px rgba(255, 255, 255, 0.1)'
      : '0px 2px 10px rgba(0, 0, 0, 0.05)', // Sombra ajustada ao tema
    ...theme.scrollbarStylesSoftBig,
  },
   mainPaperFilter: {
    flex: 1,
    overflow: 'auto',
    height: '25vh', // Ajuste da altura
    padding: '20px', // Adicionando padding interno
    backgroundColor: theme.palette.type === 'dark' ? '#151718' : '#ffffff', // Fundo ajustado ao tema
  ...
  connectionTag: {
    background: theme.palette.vcard.main, // Ajusta ao tema global
    color: theme.palette.getContrastText(theme.palette.vcard.main), // Texto com contraste adequado
    padding: '5px 10px',
    fontWeight: 'bold',
  ...
  button: {
    ...
    color: theme.palette.primary.contrastText, // Cor de texto baseada no tema
    '&:hover': {
      backgroundColor: theme.palette.primary.dark, // Cor de hover ajustada ao tema
    },
    margin: '5px',
    boxShadow: theme.palette.mode === 'dark'
      ? '0px 2px 10px rgba(255, 255, 255, 0.1)'
