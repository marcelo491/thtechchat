...
const useStyles = makeStyles((theme) => ({
  mainPaper: {
    ...
    paddingBottom: 100,
    border: "none", // Remove qualquer border
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>
            ...
            <br /> Para realizar o cadastro acesse o menu "Conexões", clique no botão editar da conexão e insira o token no devido campo.
          </li>
          <li>
