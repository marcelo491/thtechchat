...
// Constante para identificar o usuário admin padrão
...
const Users = () => {
  ...
  const handleDeleteUser = async (userId) => {
    // Verificação para impedir a exclusão do usuário admin padrão
    if (userId === DEFAULT_USER_ID) {
      toast.warning("Não é possível excluir o usuário admin padrão.");
                ...
                <TableRow key={user.id}>
                  ...
                  <TableCell align="center">
                    ...
                    {user.id === DEFAULT_USER_ID ? (
                      <Tooltip
                        title="Por padrão, esse admin não pode ser excluído por motivo de segurança"
                        placement="top"
                      >
                        <span>
